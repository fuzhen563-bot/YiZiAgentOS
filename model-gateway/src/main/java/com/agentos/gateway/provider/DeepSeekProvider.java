...
public class DeepSeekProvider extends AbstractModelProvider {
    ...
    public DeepSeekProvider(ProviderConfig config) {
        super(config);
    }
    ...
    public ModelResponse call(ModelRequest request) {
        ...
        try {
            ...
            if (result == null) {
                return new ModelResponse().failure("DeepSeek returned empty response");
            }
            List<Map<String, Object>> choices = (List<Map<String, Object>>) result.get("choices");
            if (choices == null || choices.isEmpty()) {
                return new ModelResponse().failure("DeepSeek returned no choices");
            }
            ...
            return new ModelResponse().failure("DeepSeek call failed: " + e.getMessage());
        }
    }
